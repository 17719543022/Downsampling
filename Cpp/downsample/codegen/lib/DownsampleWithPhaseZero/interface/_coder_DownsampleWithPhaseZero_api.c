/*
 * File: _coder_DownsampleWithPhaseZero_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "DownsampleWithPhaseZero",           /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void DownsampleWithPhaseZero_atexit(void)
{
  ...
  DownsampleWithPhaseZero_xil_terminate();
  DownsampleWithPhaseZero_xil_shutdown();
...
/*
 * File trailer for _coder_DownsampleWithPhaseZero_api.c
 *
 * [EOF]
 */
