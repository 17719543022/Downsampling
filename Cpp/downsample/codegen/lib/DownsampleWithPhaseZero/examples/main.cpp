...
#include "DownsampleWithPhaseZero_terminate.h"
#include "coder_array.h"

// Function Declarations
static coder::array<double, 1U> argInit_Unboundedx1_real_T();
static double argInit_real_T();
static void main_DownsampleWithPhaseZero();
...
static void main_DownsampleWithPhaseZero()
{
  ...
  // Initialize function 'DownsampleWithPhaseZero' input arguments.
  // Initialize function input argument 'x'.
  x = argInit_Unboundedx1_real_T();

  // Call the entry-point 'DownsampleWithPhaseZero'.
  DownsampleWithPhaseZero(x, argInit_real_T(), y);
}
