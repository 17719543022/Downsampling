...
static void main_Convolution()
{
  coder::array<double, 1U> a_tmp;
  coder::array<double, 1U> c;

  // Initialize function 'Convolution' input arguments.
  // Initialize function input argument 'a'.
  a_tmp = argInit_Unboundedx1_real_T();

  // Initialize function input argument 'b'.
  // Call the entry-point 'Convolution'.
  Convolution(a_tmp, a_tmp, c);
}
