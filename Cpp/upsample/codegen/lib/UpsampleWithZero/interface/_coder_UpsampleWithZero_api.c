/*
 * File: _coder_UpsampleWithZero_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "UpsampleWithZero",                  /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void UpsampleWithZero_atexit(void)
{
  ...
  UpsampleWithZero_xil_terminate();
  UpsampleWithZero_xil_shutdown();
...
/*
 * File trailer for _coder_UpsampleWithZero_api.c
 *
 * [EOF]
 */
