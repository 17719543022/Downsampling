...
#include "UpsampleWithZero_terminate.h"
#include "coder_array.h"

// Function Declarations
static coder::array<double, 1U> argInit_Unboundedx1_real_T();
static double argInit_real_T();
static void main_UpsampleWithZero();
...
static void main_UpsampleWithZero()
{
  ...
  // Initialize function 'UpsampleWithZero' input arguments.
  // Initialize function input argument 'x'.
  x = argInit_Unboundedx1_real_T();

  // Call the entry-point 'UpsampleWithZero'.
  UpsampleWithZero(x, argInit_real_T(), y);
}
