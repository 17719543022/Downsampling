/*
 * File: _coder_FIRWithLeastSquares_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "FIRWithLeastSquares",               /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
  ...
  *plhs[1])
{
  ...
  N = emlrt_marshallIn(&st, emlrtAliasP(prhs_copy_idx_0), "N");
  freq = c_emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_1), "freq");
  amp = c_emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_2), "amp");

  /* Invoke the target function */
  FIRWithLeastSquares(N, *freq, *amp, h);
...
void FIRWithLeastSquares_atexit(void)
{
  ...
  FIRWithLeastSquares_xil_terminate();
  FIRWithLeastSquares_xil_shutdown();
...
/*
 * File trailer for _coder_FIRWithLeastSquares_api.c
 *
 * [EOF]
 */
